...
export default function StudentsRequest({ navigation }) {
            ...
            {loading ? (
              ...
              <Card style={styles.noResultsCard}>
                <View style={styles.noResultsContent}>
                  ...
                  <Heading text="No students found" size="md" color="textSecondary" />
                  <Text style={styles.noResultsText}>
                    {district 
                      ? `No students found in ${district}. Try another location or clear filters.` 
                      : "No student requests available at the moment."}
                  </Text>
                  {district && (
                    <Button
                      title="Clear Filters"
